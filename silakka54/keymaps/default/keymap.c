...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // Arrow layer: held while both Shifts are pressed together (see combo below).
...
// Press LEFT SHIFT + RIGHT SHIFT together to momentarily switch to the arrow layer.
enum combos { COMBO_SHIFTS_ARROWS };

const uint16_t PROGMEM shifts_combo[] = {KC_LSFT, KC_RSFT, COMBO_END};

combo_t key_combos[] = {
    [COMBO_SHIFTS_ARROWS] = COMBO(shifts_combo, MO(_ARROWS)),
};
